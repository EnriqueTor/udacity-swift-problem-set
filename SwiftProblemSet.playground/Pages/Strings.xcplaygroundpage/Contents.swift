...
var lastName: String = "Torrendell"
...
var amountOfDollars = numOfPennies / 100
var amountOfPennies = numOfPennies % 100
var totalAmount = "$\(amountOfDollars).\(amountOfPennies)"
//desired output = "$5.67"
...
var weeklyEarningsString = "On average, millenials spend \(averageMonthlyEarnings/averageRent)% of their income on rent."
/*:
 ****
 [Table of Contents](Table%20of%20Contents) | [Previous](@previous) | [Next](@next)
 */
